...
public final class Static514 {
    ...
    public static final PickList aClass213_3 = new PickList(false);

    @OriginalMember(owner = "client!qca", name = "v", descriptor = "Lclient!kn;")
    public static PickList aClass213_2 = aClass213_3;
